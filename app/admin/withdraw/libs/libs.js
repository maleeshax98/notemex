...
export default function Libs() {
  ...
  async function check(id) {
    try {
      const promise = toast.promise(
        axios.patch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/admin/withdrawals`, {
          id: id,
          action: "CHECK",
        }),
        {
  ...
  async function get() {
    try {
      const promise = toast.promise(
        axios.get(`${process.env.NEXT_PUBLIC_BASE_URL}/api/admin/withdrawals`),
        {
          loading: "Loading...",
          success: "Success",
        }
